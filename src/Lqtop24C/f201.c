...
C[39]=+S[4]*(S[3]*(V[17]*(S[1]*(4*V[18]-2*V[17])+S[0]*(2*V[18]+V[17]))+S[2]*
 (S[0]-2*S[1])));
C[38]=+S[4]*(S[1]*(V[17]*(S[1]*(8*V[18]-4*V[17])+S[0]*(2*V[18]+V[17]))+S[2]*
 (S[0]-4*S[1])));
...
C[34]=+S[3]*(V[17]*(S[1]*(16*V[18]-8*V[17])+S[0]*(8*V[18]+4*V[17]))+S[2]*(4*
 S[0]-8*S[1]));
C[33]=+S[5]*(S[1]*(V[17]*(S[1]*(32*V[18]-16*V[17])+S[0]*(8*V[18]+4*V[17]))+
 S[2]*(4*S[0]-16*S[1])));
C[32]=+S[1]*(V[17]*(S[1]*(32*V[18]-16*V[17])+S[0]*(8*V[18]+4*V[17]))+S[2]*(
 4*S[0]-16*S[1]));
...
C[12]=+S[5]*(S[1]*(V[17]*(S[1]*(4*V[17]-8*V[18])+S[0]*(4*V[18]+2*V[17]))+
 S[2]*(2*S[0]+4*S[1])));
C[11]=+S[4]*(S[1]*(V[17]*(4*V[17]-8*V[18])+4*S[2]));
C[10]=+S[5]*(S[1]*(V[17]*(8*V[17]-16*V[18])+8*S[2]));
C[9]=+S[4]*(S[1]*(S[0]*(V[17]*(4*V[18]+2*V[17])+2*S[2])));
C[8]=+S[4]*(S[1]*(V[17]*(2*V[17]-4*V[18])+2*S[2]));
C[7]=+S[5]*(S[1]*(S[0]*(V[17]*(8*V[18]+4*V[17])+4*S[2])));
C[6]=+S[5]*(S[1]*(V[17]*(4*V[17]-8*V[18])+4*S[2]));
C[5]=+S[4]*(S[0]*(V[17]*(2*V[18]+V[17])+S[2]));
C[4]=+S[4]*(V[17]*(2*V[17]-4*V[18])+2*S[2]);
C[3]=+S[5]*(S[0]*(V[17]*(4*V[18]+2*V[17])+2*S[2]));
