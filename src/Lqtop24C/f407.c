...
S[2]=V[20]*V[20];
S[3]=V[8]*V[8]*V[8]*V[8];
C[20]=+S[3]*(V[19]*(S[1]*(V[19]-2*V[20])+S[0]*(2*V[20]+V[19]))+S[2]*(S[0]+
 S[1]));
C[19]=+S[3]*(S[1]*(V[19]*(S[1]*(2*V[20]-V[19])+S[0]*(2*V[20]+V[19]))+S[2]*(
 S[0]-S[1])));
S[4]=V[8]*V[8];
C[18]=+S[4]*(V[19]*(S[1]*(4*V[19]-8*V[20])+S[0]*(8*V[20]+4*V[19]))+S[2]*(4*(
 S[0]+S[1])));
C[17]=+V[19]*(S[1]*(4*V[19]-8*V[20])+S[0]*(8*V[20]+4*V[19]))+S[2]*(4*(S[0]+
 S[1]));
C[16]=+S[4]*(S[1]*(V[19]*(S[1]*(8*V[20]-4*V[19])+S[0]*(8*V[20]+4*V[19]))+
 S[2]*(4*(S[0]-S[1]))));
C[15]=+S[1]*(V[19]*(S[1]*(8*V[20]-4*V[19])+S[0]*(8*V[20]+4*V[19]))+S[2]*(4*(
 S[0]-S[1])));
C[14]=+S[4]*(S[1]*(V[19]*(16*V[19]-32*V[20])+16*S[2]));
C[13]=+S[4]*(V[19]*(8*V[19]-16*V[20])+8*S[2]);
C[12]=+S[1]*(V[19]*(16*V[19]-32*V[20])+16*S[2]);
C[11]=+V[19]*(8*V[19]-16*V[20])+8*S[2];
C[10]=+S[1]*(V[19]*(8*V[19]-16*V[20])+8*S[2]);
C[9]=+S[4]*(V[19]*(S[1]*(2*V[19]-4*V[20])+S[0]*(4*V[20]+2*V[19]))+S[2]*(2*(
 S[0]+S[1])));
C[8]=+S[4]*(S[1]*(V[19]*(S[1]*(4*V[20]-2*V[19])+S[0]*(4*V[20]+2*V[19]))+
 S[2]*(2*(S[0]-S[1]))));
C[7]=+S[3]*(S[1]*(V[19]*(4*V[19]-8*V[20])+4*S[2]));
C[6]=+S[4]*(S[1]*(V[19]*(8*V[19]-16*V[20])+8*S[2]));
C[5]=+S[3]*(V[19]*(2*V[19]-4*V[20])+2*S[2]);
C[4]=+S[4]*(V[19]*(4*V[19]-8*V[20])+4*S[2]);
C[3]=+S[3]*(S[1]*(V[19]*(2*V[19]-4*V[20])+2*S[2]));
C[2]=+S[4]*(S[1]*(V[19]*(4*V[19]-8*V[20])+4*S[2]));
S[5]=V[14]*V[14];
S[6]=V[2]*V[2]*V[2]*V[2];
C[1]=+3*S[5]*S[6];
S[7]=V[33]*V[33];
