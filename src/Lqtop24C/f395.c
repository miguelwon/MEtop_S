...
S[1]=V[11]*V[11];
S[2]=V[8]*V[8]*V[8]*V[8];
C[24]=+S[2]*(S[1]*(V[17]*(2*V[18]+7*V[17])+7*S[0]));
S[3]=V[17]*V[17];
C[23]=+S[2]*(S[1]*(9*(S[0]+S[3])));
C[22]=+S[2]*(V[17]*(8*V[17]-16*V[18])+8*S[0]);
S[4]=V[8]*V[8];
C[21]=+S[4]*(S[1]*(V[17]*(8*V[18]+28*V[17])+28*S[0]));
C[20]=+S[4]*(S[1]*(36*(S[0]+S[3])));
C[19]=+S[1]*(V[17]*(8*V[18]+28*V[17])+28*S[0]);
C[18]=+S[1]*(36*(S[0]+S[3]));
C[17]=+S[4]*(V[17]*(32*V[17]-64*V[18])+32*S[0]);
C[16]=+V[17]*(32*V[17]-64*V[18])+32*S[0];
C[15]=+24*V[18]*V[17]*S[1]*S[4];
C[14]=+S[4]*(S[1]*(V[17]*(28*V[17]-40*V[18])+28*S[0]));
C[13]=+24*V[18]*V[17]*S[1];
C[12]=+S[1]*(V[17]*(28*V[17]-40*V[18])+28*S[0]);
C[11]=+V[17]*(16*V[17]-32*V[18])+16*S[0];
C[10]=+S[4]*(S[1]*(V[17]*(4*V[18]+14*V[17])+14*S[0]));
C[9]=+S[4]*(S[1]*(18*(S[0]+S[3])));
C[8]=+S[4]*(V[17]*(16*V[17]-32*V[18])+16*S[0]);
C[7]=+6*V[18]*V[17]*S[1]*S[2];
C[6]=+12*V[18]*V[17]*S[1]*S[4];
C[5]=+S[2]*(S[1]*(V[17]*(7*V[17]-10*V[18])+7*S[0]));
C[4]=+S[4]*(S[1]*(V[17]*(14*V[17]-20*V[18])+14*S[0]));
