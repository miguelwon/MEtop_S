...
C[37]=+S[4]*(S[0]*(V[17]*(S[1]*(-2*V[18]-V[17])+S[0]*(4*V[17]-8*V[18]))+
 S[2]*(4*S[0]-S[1])));
...
C[31]=+S[5]*(S[0]*(V[17]*(S[1]*(-8*V[18]-4*V[17])+S[0]*(16*V[17]-32*V[18]))+
 S[2]*(16*S[0]-4*S[1])));
C[30]=+S[0]*(V[17]*(S[1]*(-8*V[18]-4*V[17])+S[0]*(16*V[17]-32*V[18]))+S[2]*(
 16*S[0]-4*S[1]));
...
C[21]=+S[0]*(V[17]*(8*V[17]-16*V[18])+8*S[2]);
...
C[15]=+S[5]*(S[0]*(V[17]*(S[1]*(-4*V[18]-2*V[17])+S[0]*(8*V[17]-16*V[18]))+
 S[2]*(8*S[0]-2*S[1])));
