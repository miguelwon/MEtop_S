...
S[3]=V[11]*V[11];
S[4]=V[9]*V[9];
C[12]=+S[2]*(V[19]*(S[4]*(8*V[20]-4*V[19])+S[3]*(8*V[20]+4*V[19]))+S[0]*(4*(
 S[3]-S[4])));
C[11]=+S[2]*(V[19]*(8*V[19]-16*V[20])+8*S[0]);
C[10]=+V[9]*(V[11]*(8*(S[0]-S[1])));
C[9]=+V[19]*(S[4]*(8*V[20]-4*V[19])+S[3]*(8*V[20]+4*V[19]))+S[0]*(4*(S[3]-
 S[4]));
C[8]=+V[19]*(8*V[19]-16*V[20])+8*S[0];
S[5]=V[8]*V[8]*V[8]*V[8];
C[7]=+S[5]*(V[9]*(V[11]*(2*(S[0]-S[1]))));
C[6]=+S[2]*(V[9]*(V[11]*(4*(S[0]-S[1]))));
C[5]=+S[5]*(V[19]*(S[4]*(2*V[20]-V[19])+S[3]*(2*V[20]+V[19]))+S[0]*(S[3]-
 S[4]));
C[4]=+S[5]*(V[19]*(2*V[19]-4*V[20])+2*S[0]);
C[3]=+S[2]*(V[19]*(S[4]*(4*V[20]-2*V[19])+S[3]*(4*V[20]+2*V[19]))+S[0]*(2*(
 S[3]-S[4])));
C[2]=+S[2]*(V[19]*(4*V[19]-8*V[20])+4*S[0]);
S[6]=V[14]*V[14];
S[7]=V[2]*V[2]*V[2]*V[2];
C[1]=+9*S[6]*S[7];
S[8]=V[33]*V[33];
