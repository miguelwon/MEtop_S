...
S[3]=V[8]*V[8];
C[8]=+S[3]*(S[1]*(V[17]*(8*V[18]+4*V[17])+4*S[0]));
C[7]=+S[1]*(V[17]*(8*V[18]+4*V[17])+4*S[0]);
C[6]=+S[3]*(V[17]*(8*V[17]-16*V[18])+8*S[0]);
C[5]=+V[17]*(8*V[17]-16*V[18])+8*S[0];
C[4]=+S[3]*(S[1]*(V[17]*(4*V[18]+2*V[17])+2*S[0]));
C[3]=+S[2]*(V[17]*(2*V[17]-4*V[18])+2*S[0]);
C[2]=+S[3]*(V[17]*(4*V[17]-8*V[18])+4*S[0]);
S[4]=V[14]*V[14];
S[5]=V[2]*V[2]*V[2]*V[2];
C[1]=+9*S[4]*S[5];
S[6]=V[33]*V[33];
