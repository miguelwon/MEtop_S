...
S[0]=V[18]*V[18];
S[1]=V[8]*V[8]*V[8]*V[8];
C[22]=+S[1]*(V[17]*(2*V[17]-4*V[18])+2*S[0]);
C[21]=+V[17]*(8*V[17]-16*V[18])+8*S[0];
S[2]=V[11]*V[11];
S[3]=V[8]*V[8];
C[20]=+S[3]*(S[2]*(V[17]*(16*V[18]+8*V[17])+8*S[0]));
C[19]=+S[3]*(V[17]*(32*V[17]-64*V[18])+32*S[0]);
C[18]=+S[3]*(V[17]*(40*V[17]-80*V[18])+40*S[0]);
C[17]=+S[2]*(V[17]*(16*V[18]+8*V[17])+8*S[0]);
C[16]=+V[17]*(32*V[17]-64*V[18])+32*S[0];
C[15]=+S[2]*(V[17]*(8*V[18]+4*V[17])+4*S[0]);
C[14]=+V[17]*(40*V[17]-80*V[18])+40*S[0];
C[13]=+V[17]*(16*V[17]-32*V[18])+16*S[0];
C[12]=+S[3]*(V[17]*(4*V[17]-8*V[18])+4*S[0]);
C[11]=+S[1]*(S[2]*(V[17]*(4*V[18]+2*V[17])+2*S[0]));
C[10]=+S[1]*(V[17]*(8*V[17]-16*V[18])+8*S[0]);
C[9]=+S[3]*(S[2]*(V[17]*(8*V[18]+4*V[17])+4*S[0]));
C[8]=+S[3]*(V[17]*(16*V[17]-32*V[18])+16*S[0]);
C[7]=+S[1]*(S[2]*(V[17]*(2*V[18]+V[17])+S[0]));
C[6]=+S[1]*(V[17]*(10*V[17]-20*V[18])+10*S[0]);
C[5]=+S[3]*(S[2]*(V[17]*(4*V[18]+2*V[17])+2*S[0]));
C[4]=+S[3]*(V[17]*(20*V[17]-40*V[18])+20*S[0]);
C[3]=+S[1]*(V[17]*(4*V[17]-8*V[18])+4*S[0]);
